...
def exp_adam_(
    ...
    if max_exp_avg_sq_ is not None:
        max_exp_avg_sq_.maximum_(exp_avg_exp_)
        exp_avg_exp_ = max_exp_avg_sq_
...
class ExpAdam(Transform):
    ...
    def apply(self, tensors, params, grads, loss, states, settings):
        ...
        if amsgrad:
            exp_avg, exp_avg_exp, max_exp_avg_sq = unpack_states(states, tensors, 'exp_avg', 'exp_avg_exp', 'max_exp_avg_sq', cls=TensorList)
        else:
