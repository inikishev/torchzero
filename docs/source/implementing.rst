...
* :code:`var`: :py:mod:`tz.core.OptimizationVars<torchzero.core.OptimizationVars>` object with various useful attributes, such as closure, list of current update tensors, loss, list of gradient tensors. For now we don't need this.
...
.. code:: python
    ...
    class ForeachAdam(tz.core.OptimizerModule):
        ...
        def _update(self, var, ascent:tz.TensorList):
